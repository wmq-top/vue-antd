...
export default {
  ...
  created() {
    axios({
      method: "GET",
      url: "http://192.168.3.153:3000/battery"
    }).then(res => {
      this.batteryrest = res.data[0].rest;
    });
    axios({
      method: "GET",
      url: "http://192.168.3.153:3000/batterymode"
    }).then(res => {
    ...
    axios({
      method: "GET",
      url: "http://192.168.3.153:3000/elerestshowmethod/1"
    }).then(res => {
  ...
  methods: {
    ...
    sendmessagetoparent() {
      axios({
        method: "PUT",
        url: "http://192.168.3.153:3000/batteryMode/1",
        data: this.RPC[0]
      });
      axios({
        method: "PUT",
        url: "http://192.168.3.153:3000/batteryMode/2",
        data: this.RPC[1]
      });
      axios({
        method: "PUT",
        url: "http://192.168.3.153:3000/batteryMode/3",
        data: this.RPC[2]
      });
      axios({
        method: "PUT",
